...
def run():
    ...
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        productId = shop_pb2.ProductId(product = "1127")
        productInfoResponse = stub.GetProductInfo(productId)
        print("Información del producto:", productInfoResponse.description)
        print("Numero de productos en existencia:", str(productInfoResponse.quentity))
